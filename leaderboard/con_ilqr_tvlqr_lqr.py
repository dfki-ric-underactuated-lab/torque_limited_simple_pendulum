...
from sim_parameters import mass, length, damping, gravity, coulomb_fric, inertia, dt, t_final, t0, x0, goal, integrator
...
controller1 = TVLQRController(data_dict=data_dict, mass=mass, length=length,
