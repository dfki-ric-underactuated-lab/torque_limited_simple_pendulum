...
filepath = "../../data/models/sp_parameters.yaml"
...
torque_limit = 3.0 # params["torque_limit"]
...
if __name__ == "__main__":                      
    ...
    if args.pd and args.ak80_6:
        (start, end, meas_dt, meas_pos, meas_vel, meas_tau, meas_time) = \
            motor_control_loop.ak80_6(CSV_FILE, Kp, Kd, n, dt, des_pos,
                                      des_vel, des_tau, meas_pos,
