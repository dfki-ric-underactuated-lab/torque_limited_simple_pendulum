...
For installing the optimal control library Crocoddyl, we refer to the instructions provided in the `Crocoddyl github repository <https://github.com/loco-3d/crocoddyl>`_ and recommend the installation through robotpkg.

`Crocoddyl <https://github.com/loco-3d/crocoddyl>`_ has an interface to the gepetto-viewer for visualization. For installing the gepetto viewer we refer to their `github repository <https://github.com/Gepetto/gepetto-viewer-corba>`_.
